...
export default function FinishCategorysPage() {
  ...
  const searchEnabled = isFinishCategorySearchEnabled({
    yearFilterEnabled,
    year,
    lotStatusRadio,
    workDate,
  ...
  return (
    <main className="page finishCategoryPage">
      ...
      <section className="finishCategoryToolbarRow finishCategoryToolbarRowSearch" aria-label="検索条件">
        <fieldset className="finishCategoryGroupBox finishCategorySearchYearGroup">
          <legend>年度</legend>
          <label>
            <input
              type="checkbox"
          ...
          <div
            className={`finishCategoryMakeYearWrap${yearFilterEnabled ? "" : " isDisabled"}`}
